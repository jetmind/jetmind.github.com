...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_12959 = 0;while(true){
if((i_12959 < arr.length))
{(arr[i_12959] = null);
{
...
{var i_12966 = (self__.level + 1);while(true){
if((i_12966 <= (new_level + 1)))
{(update[i_12966] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_12968 = 0;while(true){
if((i_12968 <= self__.level))
{var links_12969 = (update[i_12968]).forward;if(((links_12969[i_12968]) === x__$1))
{(links_12969[i_12968] = (x__$1.forward[i_12968]));
{
var G__12970 = (i_12968 + 1);
i_12968 = G__12970;
continue;
}
} else
{{
var G__12971 = (i_12968 + 1);
i_12968 = G__12971;
continue;
}
}
