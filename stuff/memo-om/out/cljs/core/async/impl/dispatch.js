...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12994 = 0;while(true){
var m_12995 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12995 == null))
{} else
{m_12995.call(null);
if((count_12994 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12996 = (count_12994 + 1);
count_12994 = G__12996;
continue;
}
} else
{}
